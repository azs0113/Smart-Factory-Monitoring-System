...
<html >
  <head>
    ...
    <title>Production Line 2 Display </title>
  ...
  <body>
	...
	<div class="form">
		<form class="menu-form">
			...
			<?php
					echo "<p align='left'><b>Welcome Admin, You are viewing Production Line 2 </p>";
					$servername = "";
					$username = "";
					$password = "";
					$dbname = "";
					...
					if (mysqli_connect_errno())
						...
						$result1 = mysqli_query($con,"select sensor_id, sensor_value from sensor_table where sensor_value= (select MAX(sensor_value) from sensor_table where sensor_id IN (6,7,8)) LIMIT 1 ");
						...
						$result2 = mysqli_query($con,"select sensor_id, sensor_value from sensor_table where sensor_value= (select MIN(sensor_value) from sensor_table where sensor_id IN (6,7,8)) LIMIT 1 ");
						...
						$result3 = mysqli_query($con,"select AVG(sensor_value) as avg_value from sensor_table where sensor_id IN(6,7,8) ");
